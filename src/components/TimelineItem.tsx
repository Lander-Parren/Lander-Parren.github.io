...
const TimelineItem = ({ year, title, duration, details } : { year: string, title: string, duration: string, details: string }) => {
    return (
        <ol 
            className="flex flex-col md:flex-row relative border-l border-stone-200 dark:border-stone-700 transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-105"
        >
